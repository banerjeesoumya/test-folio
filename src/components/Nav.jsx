      ...
      <div className="flex justify-between items-center w-full">
        <div className="pl-20 flex-grow flex justify-center">
          <ul className="flex space-x-6">
            <li className='text-lg sm:text-xl lg:text-xl leading-relaxed font-mono font-light cursor-pointer transition duration-300 ease-in-out transform hover:scale-125 hover:text-violet-400 colors'>
